 ...
 */
class Reservation extends \AppBundle\Entity\Reservation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Reservation' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Reservation' . "\0" . 'nbReservedSeats', '' . "\0" . 'AppBundle\\Entity\\Reservation' . "\0" . 'publicationDate', '' . "\0" . 'AppBundle\\Entity\\Reservation' . "\0" . 'passenger', '' . "\0" . 'AppBundle\\Entity\\Reservation' . "\0" . 'flight', '' . "\0" . 'AppBundle\\Entity\\Reservation' . "\0" . 'wasDone'];
        }
    ...
    public function setNbReservedSeats($nbReservedSeats)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbReservedSeats', [$nbReservedSeats]);

        return parent::setNbReservedSeats($nbReservedSeats);
    }
    ...
    public function getNbReservedSeats()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNbReservedSeats', []);

        return parent::getNbReservedSeats();
    }
