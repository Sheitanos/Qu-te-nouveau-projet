 ...
 */
class terrain extends \AppBundle\Entity\terrain implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\terrain' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\terrain' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\terrain' . "\0" . 'icao', '' . "\0" . 'AppBundle\\Entity\\terrain' . "\0" . 'latitude', '' . "\0" . 'AppBundle\\Entity\\terrain' . "\0" . 'longitude', '' . "\0" . 'AppBundle\\Entity\\terrain' . "\0" . 'adress', '' . "\0" . 'AppBundle\\Entity\\terrain' . "\0" . 'city', '' . "\0" . 'AppBundle\\Entity\\terrain' . "\0" . 'zipcode', '' . "\0" . 'AppBundle\\Entity\\terrain' . "\0" . 'country'];
        }
